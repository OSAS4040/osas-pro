...
// Login as owner
$login = req("$base/auth/login", 'POST', ['email' => 'owner@demo.sa', 'password' => 'Password123!']);
...
// Fleet login
echo "\n── Fleet Portal ──\n";
$fleet = req("$base/auth/login", 'POST', ['email' => 'fleet.contact@demo.sa', 'password' => 'Password123!']);
