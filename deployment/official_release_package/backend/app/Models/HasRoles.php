...
trait HasRoles
{
    ...
    public function hasRole(string|array $roles): bool
    {
        ...
        $roleValue = $this->role;
        if ($roleValue instanceof \BackedEnum) {
            $roleValue = $roleValue->value;
        } elseif ($roleValue instanceof \UnitEnum) {
    ...
    {
        $roleAttr = $this->role;
        if ($roleAttr instanceof \UnitEnum) {
            $role = $roleAttr instanceof \BackedEnum ? $roleAttr->value : $roleAttr->name;
        } else {
