  ...
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-3">
        <RouterLink to="/services-products/products" class="text-gray-400 hover:text-gray-600">
    ...
    <form class="bg-white rounded-xl border border-gray-200 p-6 space-y-5" @submit.prevent="save">
      ...
      <div class="flex justify-end gap-3 pt-2 border-t border-gray-100">
        <RouterLink to="/services-products/products" class="px-4 py-2 text-sm border border-gray-300 rounded-lg hover:bg-gray-50">إلغاء</RouterLink>
...
async function save() {
  ...
  try {
    ...
    router.push('/services-products/products')
  } catch (e: any) {
