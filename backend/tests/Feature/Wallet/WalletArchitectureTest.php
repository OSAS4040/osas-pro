...
class WalletArchitectureTest extends TestCase
{
    ...
    private function createCustomer(array $tenant): Customer
    {
    ...
    private function createVehicle(array $tenant, Customer $customer): Vehicle
    {
    ...
    private function createMinimalInvoice(array $tenant, Customer $customer, ?int $vehicleId = null): Invoice
    {
