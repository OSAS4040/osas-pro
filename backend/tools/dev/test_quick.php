...
function pass(string $l): void
{
    global $pass;
    $pass++;
    echo "\e[32m✅ PASS\e[0m  $l\n";
}
...
if ($bayId) {
    ...
    if ($r['code'] === 201) {
        pass("حجز L01 $slotStart");
        $bookingId = $r['body']['data']['id'];
    } else {
        fail('إنشاء حجز', $r['raw']);
    }
