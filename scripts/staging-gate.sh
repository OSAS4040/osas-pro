...
docker compose exec -T app sh -lc "cd /var/www && php artisan config:clear && ./vendor/bin/phpunit tests/Unit/Support/SaasPlatformAccessTest.php tests/Feature/Saas/"
