...
## ملاحظة
الفهرس مستند إلى router الفعلي، وتفاصيل الوظائف مرتبطة بصلاحيات وfeature flags. ترتيب القائمة الجانبية للموظفين: تشغيلي → مخزون وكتالوج → مالية → تقارير وتحليلات → موارد بشرية → إداري (مجموعات قابلة للطي).
