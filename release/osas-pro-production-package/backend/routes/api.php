...
Route::prefix('v1')->group(function () {
    ...
    /**
     * مشغّلو المنصة — بدون سياق مستأجر (company_id يجب أن يكون null على الحساب).
     * لا tenant/subscription هنا لأن GlobalTenantGuardMiddleware يرفض company_id الفارغ.
     */
