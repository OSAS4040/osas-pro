...
{
    protected $signature = 'integrity:verify {--quiet-check : Minimal output}';

    protected $description = 'Run non-financial integrity checks (DB, platform IAM schema).';
    ...
    public function handle(): int
    {
        ...
        if (! $this->option('quiet-check')) {
            $this->info('integrity:verify passed (DB + platform IAM tables).');
        }
