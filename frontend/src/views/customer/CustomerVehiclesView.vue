  ...
  <div class="space-y-5" dir="rtl">
    ...
    <div class="flex items-center justify-between">
      ...
      <button @click="openAdd"
        class="flex items-center gap-1.5 bg-orange-500 hover:bg-orange-600 text-white text-sm px-4 py-2 rounded-xl transition-colors shadow-sm">
    ...
    <div v-else-if="!vehicles.length" class="text-center py-14">
      ...
      <button @click="openAdd" class="mt-3 text-orange-500 text-sm hover:underline">أضف مركبتك الأولى</button>
    </div>
        ...
        <div v-if="showAdd" class="fixed inset-0 bg-black/40 z-50 flex items-end sm:items-center justify-center p-4" dir="rtl"
          ...
          <div class="bg-white dark:bg-slate-800 rounded-2xl w-full max-w-md shadow-2xl">
            <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-slate-700">
              ...
              <button @click="showAdd = false" class="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700">
            ...
            <div class="flex gap-2 px-5 py-4 border-t border-gray-100 dark:border-slate-700">
              <button @click="showAdd = false" class="flex-1 py-2.5 border border-gray-300 dark:border-slate-600 rounded-xl text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700">إلغاء</button>
              <button @click="submit" :disabled="saving"
                class="flex-1 py-2.5 bg-orange-500 hover:bg-orange-600 disabled:opacity-50 text-white rounded-xl text-sm font-semibold transition-colors">
