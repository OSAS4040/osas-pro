...
describe('platform admin route views', () => {
  it('dynamic-imports every platform view entry', async () => {
    const loaders = [
      ...
      () => import('./PlatformIncidentCenterView.vue'),
      () => import('./PlatformIncidentDetailView.vue'),
      () => import('./PlatformCommandSurfaceView.vue'),
      () => import('./PlatformCompanyDetailView.vue'),
      () => import('./pricing/PlatformPricingRequestsView.vue'),
      () => import('./pricing/PlatformPricingRequestDetailView.vue'),
      () => import('./pricing/PlatformServiceProvidersView.vue'),
      () => import('./pricing/PlatformProviderCostsView.vue'),
      () => import('./pricing/PlatformCustomerPriceVersionsView.vue'),
      () => import('./pricing/PlatformPriceListsInfoView.vue'),
      () => import('./pricing/PlatformContractsBridgeView.vue'),
      () => import('./pricing/PlatformCommercialPulseView.vue'),
      () => import('./PlatformPurchaseClaimsView.vue'),
