<template>
  <Teleport to="body">
    ...
    <button
      @click="togglePanel"
      class="fixed bottom-6 left-6 z-[9990] w-12 h-12 rounded-full shadow-lg flex items-center justify-center transition-all duration-200 hover:scale-110 focus:outline-none"
    ...
    <Transition name="panel-slide">
      <div
        v-if="open"
        class="fixed top-0 right-0 z-[9989] h-full w-[400px] max-w-full shadow-2xl flex flex-col"
      ...
      >
        ...
        <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-gray-700 flex-shrink-0">
          ...
          <div class="flex items-center gap-2">
            ...
            <button @click="open = false" class="p-1 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
        ...
        <div class="px-4 py-3 border-b border-gray-100 dark:border-gray-700 flex-shrink-0">
          <div class="flex items-center gap-2 bg-gray-50 dark:bg-gray-800 rounded-xl px-3 py-2 border border-gray-200 dark:border-gray-600 focus-within:border-primary-400 dark:focus-within:border-primary-500 transition-colors">
            ...
            />
            <button v-if="searchQuery" @click="searchQuery = ''" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
...
const quickActions: QuickAction[] = [
  ...
  {
    label: 'أمر عمل جديد',
    description: 'أنشئ أمر عمل للورشة',
    route: '/work-orders/create',
    icon: WrenchScrewdriverIcon,
    iconBg: 'bg-yellow-100 dark:bg-yellow-900/30',
    iconColor: 'text-yellow-600 dark:text-yellow-400',
    keywords: ['امر', 'أمر', 'عمل', 'ورشة', 'صيانة'],
  },
  {
    label: 'عرض سعر',
